let postingFormAV = document.getElementById('visibleElement2');
let saveButtonAV = document.getElementById('saveButton');
...
async function getAudioVideoForm(frontName, selectedCategoryId) {
    saveButtonAV.onclick = () => sentAudioVideoPosting(frontName, selectedCategoryId);

    postingFormAV.innerHTML = '<div id="parameters" class="main-container">\n' +
